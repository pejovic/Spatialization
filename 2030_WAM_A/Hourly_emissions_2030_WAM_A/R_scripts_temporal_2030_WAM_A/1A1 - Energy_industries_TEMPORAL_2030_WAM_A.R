...
#+ include = FALSE
sf.1A1a_ep <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/1A1 - Energy_2030_WAM_A/1A1a_ep.gpkg")
...
#+
 ...
 sf.1A1a_ep.tl <- lapply(sf.1A1a_ep.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything()) %>% dplyr::rename_at(vars(-1), ~ paste(sf.1A1a_ep_df$ID)))
...
#+ include = FALSE
sf.1A1a_hp <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/1A1 - Energy_2030_WAM_A/1A1a_hp.gpkg")
sf.1A1a_hp$PM10
#'
#+ echo = FALSE, result = TRUE, eval = TRUE
...
sf.1A1a_hp.tl <- lapply(sf.1A1a_hp.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything()) %>% dplyr::rename_at(vars(-1), ~ paste(sf.1A1a_hp_df$ID)))
...
#           #' ## 1A1b - Refineries
#           #+ include = FALSE
#           sf.1A1b <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/1A1 - Energy_2030_WAM_A/1A1b.gpkg")
#           
#           #'
#           #+ echo = FALSE, result = TRUE, eval = TRUE
#           t.1A1b <- sf.1A1b %>%
...
#           # 
#           # sf.1A1b.tl <- lapply(sf.1A1b.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything()))
#           # 
#           # # str(sf.1A1b.tl)
#           # 
...
#           #+ include = FALSE
#           sf.1B2aiv <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/1A1 - Energy_2030_WAM_A/1B2aiv.gpkg")
#           
#           #'
#           #+ echo = FALSE, result = TRUE, eval = TRUE
#           t.1B2aiv <- sf.1B2aiv %>%
...
#           # 
#           # sf.1B2aiv.tl <- lapply(sf.1B2aiv.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything()))
#           # 
#           # # str(sf.1B2aiv.tl)
#           # 
...
#+ include = FALSE
sf.1B2c <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/1A1 - Energy_2030_WAM_A/1B2c.gpkg")
sf.1B2c$NOx
#'
#+ echo = FALSE, result = TRUE, eval = TRUE
t.1B2c <- sf.1B2c %>%
...
sf.1B2c.tl <- lapply(sf.1B2c.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(sf.1B2c_df$ID)))
...
#+ include = FALSE
sf.1A1c <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/1A1 - Energy_2030_WAM_A/1A1c.gpkg")
...
sf.1A1c.tl <- lapply(sf.1A1c.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(sf.1B2c_df$ID)))
...
sf.1B1b <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/1A1 - Energy_2030_WAM_A/1B1b.gpkg")
...
sf.1B1b.tl <- lapply(sf.1B1b.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(sf.1B2c_df$ID)))
...
temporalProfile_Energy <- activity.df$times_2030_WAM_A %>% 
...
writexl::write_xlsx(temporalProfile_Energy, path = '2030_WAM_A/Hourly_emissions_2030_WAM_A/Products_2030_WAM_A/TemporalProfile_Energy_industries_2030_WAM_A.xlsx')
