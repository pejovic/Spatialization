...
activity.df$times_2030_WAM_A_WAM_A <- seq.POSIXt(from = ymd_h("2030-01-01 00"),
...
#+ include = FALSE
sf.1A1b_1B2aiv <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/1A2 - Industry_2030_WAM_A/1A1b_1B2aiv.gpkg")
...
sf.1A1b_1B2aiv.tl <- lapply(sf.1A1b_1B2aiv.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A2a <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/1A2 - Industry_2030_WAM_A/1A2a.gpkg")
...
sf.1A2a.tl <- lapply(sf.1A2a.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A2b <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/1A2 - Industry_2030_WAM_A/1A2b.gpkg")
...
sf.1A2b.tl <- lapply(sf.1A2b.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A2c <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/1A2 - Industry_2030_WAM_A/1A2c.gpkg")
...
sf.1A2c.tl <- lapply(sf.1A2c.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A2d <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/1A2 - Industry_2030_WAM_A/1A2d.gpkg")
...
sf.1A2d.tl <- lapply(sf.1A2d.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything()) %>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A2e <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/1A2 - Industry_2030_WAM_A/1A2e.gpkg")
...
sf.1A2e.tl <- lapply(sf.1A2e.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A2e.bread <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/1A2 - Industry_2030_WAM_A/1A2e.bread.gpkg")
...
sf.1A2e.bread.tl <- lapply(sf.1A2e.bread.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A2e.wine <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/1A2 - Industry_2030_WAM_A/1A2e.wine.gpkg")
...
sf.1A2e.wine.tl <- lapply(sf.1A2e.wine.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A2f <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/1A2 - Industry_2030_WAM_A/1A2f.gpkg")
...
sf.1A2f.tl <- lapply(sf.1A2f.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
#+ include = FALSE
sf.1A2g <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/1A2 - Industry_2030_WAM_A/1A2g.gpkg")
...
sf.1A2g.tl <- lapply(sf.1A2g.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
#+ include = FALSE
sf.1A2gvi <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/1A2 - Industry_2030_WAM_A/1A2g-Auto-production.gpkg")
...
sf.1A2gvi.tl <- lapply(sf.1A2gvi.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A2gvii <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/1A2 - Industry_2030_WAM_A/1A2gvii.gpkg")
...
sf.1A2gvii.tl <- lapply(sf.1A2gvii.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
temporalProfile_Industry <- activity.df$times_2030_WAM_A %>% 
...
writexl::write_xlsx(temporalProfile_Industry, path = '2030_WAM_A/Hourly_emissions_2030_WAM_A/Products_2030_WAM_A/TemporalProfile_Industrial_processes_2030_WAM_A.xlsx')
