...
sf.3B3 <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/3 - Agriculture_2030_WAM_A/3B3.gpkg")
...
sf.3B3.tl <- lapply(sf.3B3.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.3B4gi_gii <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/3 - Agriculture_2030_WAM_A/3B4gi_gii.gpkg")
...
sf.3B4gi_gii.tl <- lapply(sf.3B4gi_gii.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.3B1a <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/3 - Agriculture_2030_WAM_A/3B1a.gpkg")
...
sf.3B1a.tl <- lapply(sf.3B1a.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids))%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.3B1b <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/3 - Agriculture_2030_WAM_A/3B1b.gpkg")
...
sf.3B1b.tl <- lapply(sf.3B1b.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.3B2 <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/3 - Agriculture_2030_WAM_A/3B2.gpkg")
...
sf.3B2.tl <- lapply(sf.3B2.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.3B4d <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/3 - Agriculture_2030_WAM_A/3B4d.gpkg")
...
sf.3B4d.tl <- lapply(sf.3B4d.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.3B4e <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/3 - Agriculture_2030_WAM_A/3B4e.gpkg")
...
sf.3B4e.tl <- lapply(sf.3B4e.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.3B4giii <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/3 - Agriculture_2030_WAM_A/3B4giii.gpkg")
...
sf.3B4giii.tl <- lapply(sf.3B4giii.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.3B4giv <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/3 - Agriculture_2030_WAM_A/3B4giv.gpkg")
...
sf.3B4giv.tl <- lapply(sf.3B4giv.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.3Da1 <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/3 - Agriculture_2030_WAM_A/3Da1.gpkg")
...
sf.3Da1.tl <- lapply(sf.3Da1.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.3Da2a <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/3 - Agriculture_2030_WAM_A/3Da2a.gpkg")
...
sf.3Da2a.tl <- lapply(sf.3Da2a.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.3Da3 <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/3 - Agriculture_2030_WAM_A/3Da3.gpkg")
...
sf.3Da3.tl <- lapply(sf.3Da3.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.3Dc <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/3 - Agriculture_2030_WAM_A/3Dc.gpkg")
...
sf.3Dc.tl <- lapply(sf.3Dc.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.3De <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/3 - Agriculture_2030_WAM_A/3De.gpkg")
...
sf.3De.tl <- lapply(sf.3De.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.3F <- st_read("D:/R_projects/Spatialization/2030_WAM_A/Products_2030_WAM_A/3 - Agriculture_2030_WAM_A/3F.gpkg")
...
he.3F <- activity.df %>%
  ...
  dplyr::mutate(he_3F_n = he_3F/sum(he_3F))%>%
...
sf.3F.tl <- lapply(sf.3F.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_A) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
temporalProfile_Agriculture <- activity.df$times_2030_WAM_A %>% cbind(he.3B1a[,1:6], 
                                                          he.3B1b[,1:6], 
                                                          he.3B2[,1:6], 
                                                          he.3B3[,1:6], 
                                                          he.3B4d[,1:6], 
...
writexl::write_xlsx(temporalProfile_Agriculture, path = '2030_WAM_A/Hourly_emissions_2030_WAM_A/Products_2030_WAM_A/TemporalProfile_Agriculture_2030_WAM_A.xlsx')
