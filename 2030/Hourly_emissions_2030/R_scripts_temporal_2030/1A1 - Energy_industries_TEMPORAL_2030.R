...
#+ include = FALSE
sf.1A1a_ep <- st_read("D:/R_projects/Spatialization/2030/Products_2030/1A1 - Energy_2030/1A1a_ep.gpkg")
...
#           #' ## 1A1b - Refineries
#           #+ include = FALSE
#           sf.1A1b <- st_read("D:/R_projects/Spatialization/2030/Products_2030/1A1 - Energy_2030/1A1b.gpkg")
#           
#           #'
#           #+ echo = FALSE, result = TRUE, eval = TRUE
#           t.1A1b <- sf.1A1b %>%
...
#           #+ include = FALSE
#           sf.1B2aiv <- st_read("D:/R_projects/Spatialization/2030/Products_2030/1A1 - Energy_2030/1B2aiv.gpkg")
#           
#           #'
#           #+ echo = FALSE, result = TRUE, eval = TRUE
#           t.1B2aiv <- sf.1B2aiv %>%
...
#+ include = FALSE
sf.1A1c <- st_read("D:/R_projects/Spatialization/2030/Products_2030/1A1 - Energy_2030/1A1c.gpkg")
...
sf.1B1b <- st_read("D:/R_projects/Spatialization/2030/Products_2030/1A1 - Energy_2030/1B1b.gpkg")
...
temporalProfile_Energy <- activity.df$times_2030 %>% 
...
writexl::write_xlsx(temporalProfile_Energy, path = '2030/Hourly_emissions_2030/Products_2030/TemporalProfile_Energy_industries_2030.xlsx')
