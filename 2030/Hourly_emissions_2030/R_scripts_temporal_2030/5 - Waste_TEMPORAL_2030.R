...
sf.5A <- st_read("D:/R_projects/Spatialization/2030/Products_2030/5 - Waste_2030/5A.gpkg")
...
sf.5C1bv <- st_read("D:/R_projects/Spatialization/2030/Products_2030/5 - Waste_2030/5C1bv.gpkg")
...
sf.5D1 <- st_read("D:/R_projects/Spatialization/2030/Products_2030/5 - Waste_2030/5D1.gpkg")
...
sf.5D2 <- st_read("D:/R_projects/Spatialization/2030/Products_2030/5 - Waste_2030/5D2.gpkg")
...
temporalProfile_Waste <- activity.df$times_2030 %>% cbind(he.5A[,1:6], 
                                                           he.5C1bv[,1:6], 
                                                           he.5D1[,1:6], 
                                                           he.5D2[,1:6]) %>% 
  as.data.frame()

writexl::write_xlsx(temporalProfile_Waste, path = '2030/Hourly_emissions_2030/Products_2030/TemporalProfile_Waste_2030.xlsx')
