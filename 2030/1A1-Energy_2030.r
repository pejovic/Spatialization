...
# st_write(p.1A1a_ep, dsn = "2030/Products_2030/1A1 - Energy_2030/1A1a_ep.gpkg", layer = '1A1a_ep')
...
# st_write(p.1A1a_hp, dsn = "2030/Products_2030/1A1 - Energy_2030/1A1a_hp.gpkg", layer = '1A1a_hp')
...
# st_write(p.1A1b, dsn="2030/Products_2030/1A1 - Energy_2030/1A1b_1B2aiv.gpkg", layer='1A1b_1B2aiv')
...
# 
#+ include = FALSE
# st_write(p.1B2aiv, dsn="2030/Products_2030/1A1 - Energy_2030/1B2aiv.gpkg", layer='1B2aiv')
...
# st_write(p.1B2c, dsn="2030/Products_2030/1A1 - Energy_2030/1B2c.gpkg", layer='1B2c')
...
#  st_write(p.1A1c, dsn="2030/Products_2030/1A1 - Energy_2030/1A1c.gpkg", layer='1A1c')
...
# st_write(p.1B1b, dsn="2030/Products_2030/1A1 - Energy_2030/1B1b.gpkg", layer='1B1b')
