...
sf.1B1a <- st_read("D:/R_projects/Spatialization/Products/1B - Fugitive emissions/1B1a.gpkg")
...
sf.1B2ai <- st_read("D:/R_projects/Spatialization/Products/1B - Fugitive emissions/1B2ai.gpkg")
...
sf.1B2av <- st_read("D:/R_projects/Spatialization/Products/1B - Fugitive emissions/1B2av.gpkg")
...
sf.1B2b <- st_read("D:/R_projects/Spatialization/Products/1B - Fugitive emissions/1B2b.gpkg")
