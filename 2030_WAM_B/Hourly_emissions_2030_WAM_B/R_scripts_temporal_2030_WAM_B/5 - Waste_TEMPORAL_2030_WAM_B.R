...
sf.5A <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/5 - Waste_2030_WAM_B/5A.gpkg")
...
sf.5A.tl <- lapply(sf.5A.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.5C1bv <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/5 - Waste_2030_WAM_B/5C1bv.gpkg")
...
sf.5C1bv.tl <- lapply(sf.5C1bv.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.5D1 <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/5 - Waste_2030_WAM_B/5D1.gpkg")
...
sf.5D1.tl <- lapply(sf.5D1.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.5D2 <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/5 - Waste_2030_WAM_B/5D2.gpkg")
...
sf.5D2.tl <- lapply(sf.5D2.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
temporalProfile_Waste <- activity.df$times_2030_WAM_B %>% cbind(he.5A[,1:6], 
                                                           he.5C1bv[,1:6], 
                                                           he.5D1[,1:6], 
                                                           he.5D2[,1:6]) %>% 
  as.data.frame()

writexl::write_xlsx(temporalProfile_Waste, path = '2030_WAM_B/Hourly_emissions_2030_WAM_B/Products_2030_WAM_B/TemporalProfile_Waste_2030_WAM_B.xlsx')
