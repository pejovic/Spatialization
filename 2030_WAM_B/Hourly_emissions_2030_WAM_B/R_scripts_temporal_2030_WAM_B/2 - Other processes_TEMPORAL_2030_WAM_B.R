...
sf.2A5a <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2A5a.gpkg")
...
sf.2A5a.tl <- lapply(sf.2A5a.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything()) %>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.2A5b <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2A5b.gpkg")
...
sf.2A5b.tl <- lapply(sf.2A5b.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.2A5c <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2A5c.gpkg")
...
sf.2A5c.tl <- lapply(sf.2A5c.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.2D3b <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2D3b.gpkg")
...
sf.2D3b.tl <- lapply(sf.2D3b.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.2D3c <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2D3c.gpkg")
...
sf.2D3c.tl <- lapply(sf.2D3c.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.2D3d.pfc <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2D3d.pfc.gpkg")  # PROMENIII
...
sf.2D3d.pfc.tl <- lapply(sf.2D3d.pfc.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything()))
...
sf.2D3d.cbtlf <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2D3d.cbtlf.gpkg") # PROMENIII
...
sf.2D3d.cbtlf.tl <- lapply(sf.2D3d.cbtlf.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything()))
...
sf.2D3g.rp <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2D3g.rp.gpkg") # PROMENIII
...
sf.2D3g.rp.tl <- lapply(sf.2D3g.rp.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.2D3g.pigm <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2D3g.pigm.gpkg") # PROMENIII
...
sf.2D3g.pigm.tl <- lapply(sf.2D3g.pigm.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.2D3g.ms <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2D3g.ms.gpkg") # PROMENIII
...
sf.2D3g.ms.tl <- lapply(sf.2D3g.ms.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.2D3g.lt <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2D3g.lt.gpkg") # PROMENIII
...
sf.2D3g.lt.tl <- lapply(sf.2D3g.lt.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.2D3i.feneox <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2D3i.feneox.gpkg") # PROMENIII
...
sf.2D3i.feneox.tl <- lapply(sf.2D3i.feneox.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.2D3i.pow <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2D3i.pow.gpkg") # PROMENIII
...
sf.2D3i.pow.tl <- lapply(sf.2D3i.pow.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.2D3i.utcv <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2D3i.utcv.gpkg") # PROMENIII
...
sf.2D3i.utcv.tl <- lapply(sf.2D3i.utcv.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.2D3i.t <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2D3i.t.gpkg") # PROMENIII
...
sf.2D3i.t.tl <- lapply(sf.2D3i.t.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.2D3i.uos <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2D3i.uos.gpkg") # PROMENIII
...
sf.2D3i.uos.tl <- lapply(sf.2D3i.uos.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
#+ include = FALSE
sf.2D3a <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2D3a.gpkg")
...
sf.2D3a.tl <- lapply(sf.2D3a.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything()) %>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
#' ## 2D3e - Degreasing
#+ include = FALSE
sf.2D3e <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2D3e.gpkg")
...
sf.2D3e.tl <- lapply(sf.2D3e.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.2D3f <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2D3f.gpkg")
...
sf.2D3f.tl <- lapply(sf.2D3f.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.2D3h <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2D3h.gpkg")
...
sf.2D3h.tl <- lapply(sf.2D3h.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.2I <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/2 - Other processes_2030_WAM_B/2I.gpkg")
...
sf.2I.tl <- lapply(sf.2I.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything()) %>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
temporalProfile_Other_processes <- activity.df$times_2030_WAM_B %>% cbind(he.2A5a[,1:6], 
                                                          he.2A5b[,1:6],
                                                          he.2A5c[,1:6],
                                                          he.2D3a[,1:6], 
                                                          he.2D3b[,1:6], 
...
writexl::write_xlsx(temporalProfile_Other_processes, path = '2030_WAM_B/Hourly_emissions_2030_WAM_B/Products_2030_WAM_B/TemporalProfile_Other_processes_2030_WAM_B.xlsx')
