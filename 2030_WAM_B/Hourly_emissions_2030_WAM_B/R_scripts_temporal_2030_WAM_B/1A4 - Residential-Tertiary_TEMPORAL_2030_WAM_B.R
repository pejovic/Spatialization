...
sf.1A4ai <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A4 - Residential-Tertiary_2030_WAM_B/1A4ai.gpkg")
...
sf.1A4ai.tl <- lapply(sf.1A4ai.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
#+ include = FALSE
sf.1A4bi <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A4 - Residential-Tertiary_2030_WAM_B/1A4bi.gpkg")
...
sf.1A4bi.tl <- lapply(sf.1A4bi.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
#+ include = FALSE
sf.1A4ci <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A4 - Residential-Tertiary_2030_WAM_B/1A4ci.gpkg")
...
sf.1A4ci.tl <- lapply(sf.1A4ci.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A4cii <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A4 - Residential-Tertiary_2030_WAM_B/1A4cii.gpkg")
...
sf.1A4cii.tl <- lapply(sf.1A4cii.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
temporalProfile_ResidentialTertiary <- activity.df$times_2030_WAM_B %>% 
  cbind(he.1A4ai[,1:6], 
        he.1A4bi[,1:6], 
        he.1A4ci[,1:6], 
        he.1A4cii[,1:6]) %>% 
...
writexl::write_xlsx(temporalProfile_ResidentialTertiary, path = '2030_WAM_B/Hourly_emissions_2030_WAM_B/Products_2030_WAM_B/TemporalProfile_Residential_Tertiary_2030_WAM_B.xlsx')
