...
sf.1A3ai <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3ai.gpkg")
...
sf.1A3ai.tl <- lapply(sf.1A3ai.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything()) %>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3aii <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3aii.gpkg")
...
sf.1A3aii.tl <- lapply(sf.1A3aii.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3bi_U <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3bi_U.gpkg")
...
sf.1A3bi_U.tl <- lapply(sf.1A3bi_U.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3bi_R <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3bi_R.gpkg")
...
sf.1A3bi_R.tl <- lapply(sf.1A3bi_R.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3bi_H <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3bi_H.gpkg")
...
sf.1A3bi_H.tl <- lapply(sf.1A3bi_H.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3bii_U <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3bii_U.gpkg")
...
sf.1A3bii_U.tl <- lapply(sf.1A3bii_U.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3bii_R <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3bii_R.gpkg")
...
sf.1A3bii_R.tl <- lapply(sf.1A3bii_R.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything()) %>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3bii_H <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3bii_H.gpkg")
...
sf.1A3bii_H.tl <- lapply(sf.1A3bii_H.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3biii_U <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3biii_U.gpkg")
...
sf.1A3biii_U.tl <- lapply(sf.1A3biii_U.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3biii_R <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3biii_R.gpkg")
...
sf.1A3biii_R.tl <- lapply(sf.1A3biii_R.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3biii_H <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3biii_H.gpkg")
...
sf.1A3biii_H.tl <- lapply(sf.1A3biii_H.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3biii_bc_U <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3biii_bc_U.gpkg")
...
sf.1A3biii_bc_U.tl <- lapply(sf.1A3biii_bc_U.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3biii_bc_R <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3biii_bc_R.gpkg")
...
sf.1A3biii_bc_R.tl <- lapply(sf.1A3biii_bc_R.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3biii_bc_H <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3biii_bc_H.gpkg")
...
sf.1A3biii_bc_H.tl <- lapply(sf.1A3biii_bc_H.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything()) %>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3biv_U <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3biv_U.gpkg")
...
sf.1A3biv_U.tl <- lapply(sf.1A3biv_U.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3biv_R <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3biv_R.gpkg")
...
sf.1A3biv_R.tl <- lapply(sf.1A3biv_R.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3biv_H <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3biv_H.gpkg")
...
sf.1A3biv_H.tl <- lapply(sf.1A3biv_H.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3bv_U <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3bv_U.gpkg")
...
sf.1A3bv_U.tl <- lapply(sf.1A3bv_U.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3bv_R <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3bv_R.gpkg")
...
sf.1A3bv_R.tl <- lapply(sf.1A3bv_R.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3bv_H <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3bv_H.gpkg")
...
sf.1A3bv_H.tl <- lapply(sf.1A3bv_H.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3bvi <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3bvi.gpkg")
...
sf.1A3bvi.tl <- lapply(sf.1A3bvi.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3bvii <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3bvii.gpkg")
...
sf.1A3bvii.tl <- lapply(sf.1A3bvii.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3c <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3c.gpkg")
...
sf.1A3c.tl <- lapply(sf.1A3c.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1A3dii <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A3 - Transport_2030_WAM_B/1A3dii.gpkg")
...
sf.1A3dii.tl <- lapply(sf.1A3dii.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
temporalProfile_Transports<- activity.df$times_2030_WAM_B %>% cbind(he.1A3ai[,1:6], 
                                                           he.1A3aii[,1:6], 
                                                           he.1A3bi_H[,1:6], 
                                                           he.1A3bi_R[,1:6], 
                                                           he.1A3bi_U[,1:6], 
...
writexl::write_xlsx(temporalProfile_Transports, path = '2030_WAM_B/Hourly_emissions_2030_WAM_B/Products_2030_WAM_B/TemporalProfile_Transports_2030_WAM_B.xlsx')
