...
#+ include = FALSE
sf.1A1a_ep <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A1 - Energy_2030_WAM_B/1A1a_ep.gpkg")
...
he.1A1a_ep %<>% 
  ...
  #replace_all(., is.na(.), 0) %>%
  dplyr::select(NOx_1A1a_ep_p, SO2_1A1a_ep_p, PM10_1A1a_ep_p, PM2.5_1A1a_ep_p, NMVOC_1A1a_ep_p, NH3_1A1a_ep_p) %>%
...
#+
 ...
 sf.1A1a_ep.tl <- lapply(sf.1A1a_ep.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything()) %>% dplyr::rename_at(vars(-1), ~ paste(sf.1A1a_ep_df$ID)))
...
#+ include = FALSE
sf.1A1a_hp <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A1 - Energy_2030_WAM_B/1A1a_hp.gpkg")
sf.1A1a_hp$PM10
#'
#+ echo = FALSE, result = TRUE, eval = TRUE
...
he.1A1a_hp %<>% 
  ...
  #replace_all(., is.na(.), 0) %>%
  dplyr::select(NOx_1A1a_hp_p, SO2_1A1a_hp_p, PM10_1A1a_hp_p, PM2.5_1A1a_hp_p, NMVOC_1A1a_hp_p, NH3_1A1a_hp_p) %>%
...
sf.1A1a_hp.tl <- lapply(sf.1A1a_hp.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything()) %>% dplyr::rename_at(vars(-1), ~ paste(sf.1A1a_hp_df$ID)))
...
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# PREBACUJE SE U INDUSTRY kao 1A1b_1B2aiv
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
#           #' ## 1A1b - Refineries
#           #+ include = FALSE
#           sf.1A1b <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A1 - Energy_2030_WAM_B/1A1b.gpkg")
#           
#           #'
#           #+ echo = FALSE, result = TRUE, eval = TRUE
#           t.1A1b <- sf.1A1b %>%
...
#           # 
#           # sf.1A1b.tl <- lapply(sf.1A1b.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything()))
#           # 
#           # # str(sf.1A1b.tl)
#           # 
...
#           #+ include = FALSE
#           sf.1B2aiv <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A1 - Energy_2030_WAM_B/1B2aiv.gpkg")
#           
#           #'
#           #+ echo = FALSE, result = TRUE, eval = TRUE
#           t.1B2aiv <- sf.1B2aiv %>%
...
#           # 
#           # sf.1B2aiv.tl <- lapply(sf.1B2aiv.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything()))
#           # 
#           # # str(sf.1B2aiv.tl)
#           # 
...
#+ include = FALSE
sf.1B2c <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A1 - Energy_2030_WAM_B/1B2c.gpkg")
sf.1B2c$NOx
#'
#+ echo = FALSE, result = TRUE, eval = TRUE
t.1B2c <- sf.1B2c %>%
...
he.1B2c <- activity.df %>%
  ...
  dplyr::select(times, he_1B2c, he_1B2c_n)
...
he.1B2c %<>% 
  ...
  #replace_all(., is.na(.), 0) %>%
  dplyr::select(NOx_1B2c_p, SO2_1B2c_p, PM10_1B2c_p, PM2.5_1B2c_p, NMVOC_1B2c_p, NH3_1B2c_p) %>%
...
sf.1B2c.tl <- lapply(sf.1B2c.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(sf.1B2c_df$ID)))
...
#+ include = FALSE
sf.1A1c <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A1 - Energy_2030_WAM_B/1A1c.gpkg")
...
he.1A1c <- activity.df %>%
  ...
  dplyr::select(times, he_1A1c, he_1A1c_n)
...
he.1A1c %<>% 
  ...
  #replace_all(., is.na(.), 0) %>%
  dplyr::select(NOx_1A1c_p, SO2_1A1c_p, PM10_1A1c_p, PM2.5_1A1c_p, NMVOC_1A1c_p, NH3_1A1c_p) %>%
...
sf.1A1c.tl <- lapply(sf.1A1c.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(sf.1B2c_df$ID)))
...
sf.1B1b <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1A1 - Energy_2030_WAM_B/1B1b.gpkg")
...
he.1B1b <- activity.df %>%
  ...
  dplyr::select(times, he_1B1b, he_1B1b_n)
...
he.1B1b %<>% 
  ...
  #replace_all(., is.na(.), 0) %>%
  dplyr::select(NOx_1B1b_p, SO2_1B1b_p, PM10_1B1b_p, PM2.5_1B1b_p, NMVOC_1B1b_p, NH3_1B1b_p) %>%
...
sf.1B1b.tl <- lapply(sf.1B1b.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(sf.1B2c_df$ID)))
...
temporalProfile_Energy <- activity.df$times_2030_WAM_B %>% 
cbind(he.1A1a_ep[,1:6], 
      he.1A1a_hp[,1:6], 
      he.1A1c[,1:6], 
      he.1B1b[,1 :6], 
      he.1B2c[,1:6]) %>% 
...
writexl::write_xlsx(temporalProfile_Energy, path = '2030_WAM_B/Hourly_emissions_2030_WAM_B/Products_2030_WAM_B/TemporalProfile_Energy_industries_2030_WAM_B.xlsx')
