...
sf.1B1a <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1B - Fugitive emissions_2030_WAM_B/1B1a.gpkg")
...
sf.1B1a.tl <- lapply(sf.1B1a.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1B2ai <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1B - Fugitive emissions_2030_WAM_B/1B2ai.gpkg")
...
sf.1B2ai.tl <- lapply(sf.1B2ai.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1B2av <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1B - Fugitive emissions_2030_WAM_B/1B2av.gpkg")
...
sf.1B2av.tl <- lapply(sf.1B2av.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
sf.1B2b <- st_read("D:/R_projects/Spatialization/2030_WAM_B/Products_2030_WAM_B/1B - Fugitive emissions_2030_WAM_B/1B2b.gpkg")
...
sf.1B2b.tl <- lapply(sf.1B2b.tl, function(x) data.frame(x) %>% mutate(Time = activity.df$times_2030_WAM_B) %>% dplyr::select(Time, everything())%>% dplyr::rename_at(vars(-1), ~ paste(ids)))
...
temporalProfile_Fugitive_emissions <- activity.df$times_2030_WAM_B %>% cbind(he.1B1a[,1:6], 
                                                           he.1B2ai[,1:6], 
                                                           he.1B2av[,1:6], 
                                                           he.1B2b[,1:6]) %>% 
  as.data.frame()

writexl::write_xlsx(temporalProfile_Fugitive_emissions, path = '2030_WAM_B/Hourly_emissions_2030_WAM_B/Products_2030_WAM_B/TemporalProfile_Fugitive_emissions_2030_WAM_B.xlsx')
