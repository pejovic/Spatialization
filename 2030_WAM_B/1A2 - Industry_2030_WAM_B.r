...
#p.1A2a %<>% sf::st_transform(4326)
 st_write(p.1A2a, dsn="2030_WAM_B/Products_2030_WAM_B/1A2 - Industry_2030_WAM_B/1A2a.gpkg", layer='1A2a')
...
# p.1A2b %<>% sf::st_transform(4326)
 st_write(p.1A2b, dsn="2030_WAM_B/Products_2030_WAM_B/1A2 - Industry_2030_WAM_B/1A2b.gpkg", layer='1A2b')
...
# p.1A2c %<>% sf::st_transform(4326)
  st_write(p.1A2c, dsn="2030_WAM_B/Products_2030_WAM_B/1A2 - Industry_2030_WAM_B/1A2c.gpkg", layer='1A2c')
...
# p.1A2d %<>% sf::st_transform(4326)
 st_write(p.1A2d, dsn="2030_WAM_B/Products_2030_WAM_B/1A2 - Industry_2030_WAM_B/1A2d.gpkg", layer='1A2d')
...
# p.1A2e %<>% sf::st_transform(4326)
 st_write(p.1A2e, dsn="2030_WAM_B/Products_2030_WAM_B/1A2 - Industry_2030_WAM_B/1A2e.gpkg", layer='1A2e')
...
# p.1A2e.bread %<>% sf::st_transform(4326)
 st_write(p.1A2e.bread, dsn="2030_WAM_B/Products_2030_WAM_B/1A2 - Industry_2030_WAM_B/1A2e.bread.gpkg", layer='1A2e.bread')
...
#+ include = FALSE
 st_write(p.1A2e.wine, dsn="2030_WAM_B/Products_2030_WAM_B/1A2 - Industry_2030_WAM_B/1A2e.wine.gpkg", layer='1A2e.wine')
...
#+ include = FALSE
 st_write(p.1A2f, dsn="2030_WAM_B/Products_2030_WAM_B/1A2 - Industry_2030_WAM_B/1A2f.gpkg", layer='1A2f')
...
#+ include = FALSE
 st_write(p.1A2gvi, dsn="2030_WAM_B/Products_2030_WAM_B/1A2 - Industry_2030_WAM_B/1A2g-Auto-production.gpkg", layer='1A2g-Auto-production')
...
#+ include = FALSE
 st_write(p.1A2g, dsn="2030_WAM_B/Products_2030_WAM_B/1A2 - Industry_2030_WAM_B/1A2g.gpkg", layer='1A2g')
...
#+ include = FALSE
 st_write(p.1A2gvii, dsn="2030_WAM_B/Products_2030_WAM_B/1A2 - Industry_2030_WAM_B/1A2gvii.gpkg", layer='1A2gvii')
