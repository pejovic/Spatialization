...
#+ include = FALSE
 st_write(p.1A4ai, dsn="2030_WAM_B/Products_2030_WAM_B/1A4 - Residential-Tertiary_2030_WAM_B/1A4ai.gpkg", layer='1A4ai')
...
#+ include = FALSE
# st_write(p.1A4bi, dsn="2030_WAM_B/Products_2030_WAM_B/1A4 - Residential-Tertiary_2030_WAM_B/1A4bi.gpkg", layer='1A4bi')
# st_write(p.1A4bi, dsn="Products/NOVO_25052021/1A4 - Residential-Tertiary/1A4bi_2030_WAM_B.gpkg", layer='1A4bi_2030_WAM_B')
...
#+ include = FALSE
 st_write(p.1A4ci, dsn="2030_WAM_B/Products_2030_WAM_B/1A4 - Residential-Tertiary_2030_WAM_B/1A4ci.gpkg", layer='1A4ci')
...
#+ include = FALSE
 st_write(p.1A4cii, dsn="2030_WAM_B/Products_2030_WAM_B/1A4 - Residential-Tertiary_2030_WAM_B/1A4cii.gpkg", layer='1A4cii')
