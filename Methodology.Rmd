...
- **Methodology:** Total inventory was spatialized on 5x5km cells proportionally to the length on the length  multiplied by corresponding average road activity (average daily number of vehicles for one year). These informations were taken from the 1A3 (Transport) Category. 
...
- **Methodology:** The difference between Total inventory and Total spatialized inventory was spatially allocated to the identified locations of the mines of minerals (other than coals) proportionally, by taking the existing values of point sources into account. 
